...
```bash
docker build -t registry.example.com/my-django-app:0.4.0 .
docker push registry.example.com/my-django-app:0.4.0
```
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: web
          image: registry.example.com/my-django-app:0.4.0
