...
```bash
docker build -t registry.example.com/my-django-app:1.2.3 .
docker push registry.example.com/my-django-app:1.2.3
```
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: web
          image: registry.example.com/my-django-app:1.2.3
